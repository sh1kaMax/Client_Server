...
data class Movie(private var id: Int,
    ...
    override fun toString(): String {
        return "Movie(id=$id, name='$name', coordinates=$coordinates, creationDate=$creationDate, oscarsCount=$oscarsCount, genre=$genre, mpaaRating=$mpaaRating, director=$director, username=$username)"
    }
