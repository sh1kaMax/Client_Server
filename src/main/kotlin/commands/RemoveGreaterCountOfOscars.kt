...
class RemoveGreaterCountOfOscars(collectionManager: CollectionManager, asker: Asker): AbsctractCommand("remove_greater", "удалить из коллекции все элементы, превышающие заданное количество оскаров") {
